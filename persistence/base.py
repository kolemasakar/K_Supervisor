...
class PersistenceStore(ABC):
    ...
    @abstractmethod
    def transition_project_spec(self, value: ProjectSpec, audit: AuditEvent) -> None: ...
    @abstractmethod
    ...
    @abstractmethod
    def save_service_mutation(self, value: ServiceMutationRecord) -> None: ...
    @abstractmethod
    def get_service_mutation(self, record_id: str) -> ServiceMutationRecord | None: ...
    @abstractmethod
    def list_service_mutations(self, project_id: str) -> tuple[ServiceMutationRecord, ...]: ...
    @abstractmethod
    def claim_service_command(self, value: ServiceCommandRecord) -> None: ...
    @abstractmethod
    def save_service_command(self, value: ServiceCommandRecord) -> None: ...
    @abstractmethod
    def get_service_command(self, command_id: str) -> ServiceCommandRecord | None: ...
    @abstractmethod
    def list_service_commands(self, project_id: str) -> tuple[ServiceCommandRecord, ...]: ...
    @abstractmethod
    def claim_side_effect_execution(self, value: SideEffectExecutionRecord, audit: AuditEvent) -> None: ...
    @abstractmethod
    def complete_side_effect_execution(self, value: SideEffectExecutionRecord, audit: AuditEvent) -> None: ...
    @abstractmethod
    def get_side_effect_execution(self, execution_id: str) -> SideEffectExecutionRecord | None: ...
    @abstractmethod
    def list_side_effect_executions(self, project_id: str) -> tuple[SideEffectExecutionRecord, ...]: ...
    @abstractmethod
