...
class PersistenceStore(ABC):
    ...
    @abstractmethod
    def apply_lifecycle_transition(self, project: Project, value: ProjectLifecycleTransition) -> None: ...
    @abstractmethod
    ...
    @abstractmethod
    def apply_operational_transition(self, project: Project, value: ProjectOperationalTransition) -> None: ...
    @abstractmethod
